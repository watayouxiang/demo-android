...
import com.wata.rxjava_demo_imagecachelibrary.imgloader.tools.DiskCacheUtil;
import com.wata.rxjava_demo_imagecachelibrary.imgloader.tools.DiskLruCache;
...
public class DiskCacheObservable extends  CacheObservable {
    ...
    private int maxSize=20*1024*1024;// DiskLruCache中对于图片的最大缓存值.
